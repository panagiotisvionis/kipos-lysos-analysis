...
% ---------------------------------------------------------------
% ABSTRACT (structured, max 150 words; JARID requirement)
% ---------------------------------------------------------------
\begin{abstract}
...
\noindent\textbf{Method:} A three-phase longitudinal design evaluated an arts-based socio-emotional program over three months in a Day Care Center ($n = 30$ adults). Data were collected from beneficiary self-reports, trainer/educator assessments, and independent observer ratings using a 10-item Likert-scale instrument.

\noindent\textbf{Results:} Significant improvements were observed across all evaluator sources. Beneficiary self-reports showed the largest effect ($d = 2.45$, $p < .001$), followed by the independent observer ($d = 1.65$) and trainers/educators ($d = 1.35$). Friedman tests confirmed significant longitudinal change across phases ($p < .001$).

\noindent\textbf{Conclusions:} A holistic experiential program can substantially improve emotion recognition, cooperation, group participation, and well-being among adults with disabilities in Day Care settings, supporting social inclusion and quality of life.
\end{abstract}

% ---------------------------------------------------------------
% LAY SUMMARY (3–4 bullet points; JARID requirement)
% ---------------------------------------------------------------
...
A further contribution of this study lies in the arts-based nature of the intervention. The program, entitled ``The Universe Within Us,'' included experiential practices such as theatrical expression, music, movement, symbolic object creation, and narrative activities. These practices aimed to cultivate SEL-related skills through symbolic, embodied, and interpersonal learning. Arts-based approaches have been described as particularly valuable for groups with complex support needs, as they allow expression, participation, and meaning-making beyond purely verbal modes of communication \citep{leavy2015,stickley2018}.
...
\hline
\endlastfoot
\citet{giummarra2022} & Adults ($\geq$18 yrs) with intellectual disabilities, autism spectrum disorder, and psychosocial disabilities; 57 reviews covering 522 studies & Social and community participation & Participatory inclusion and well-being & Umbrella review & Secondary synthesis & No primary data; heterogeneous outcome measures; limited longitudinal follow-up \\
\citet{littlewood2018} & $n=11$ adults with mild intellectual disabilities; age not reported & Emotion regulation in everyday life & Experiential approach & Qualitative study & Semi-structured interviews & No quantitative effectiveness measurement; limited to mild intellectual disabilities only \\
\citet{jacob2022} & Children and adolescents with intellectual disabilities across 10 studies ($n$ ranging from 3 to 296; age range: 7--19 yrs) & Social skills interventions & Behavioral and social theories & Systematic review & Diverse instruments & Heterogeneous measures; lack of unified theoretical framework; limited adult representation \\
\citet{vanutelli2023} & $n=8$ adults with intellectual disabilities; emotional skills training during COVID-19 & Emotional competencies training & Educational and experiential approach & Pilot intervention study & Pre--post assessment (quantitative and qualitative) & Very small sample; limited generalizability; no control group \\
\citet{witwer2022} & N/A -- theoretical analysis; adults with intellectual disabilities (reviewed literature) & Psychological interventions & Diverse frameworks & Scoping review & Secondary analysis & No primary sample; lack of comparable evaluations across interventions \\
\citet{mcnaughton2025} & N/A -- theoretical article; adults with developmental disabilities & Social participation and agency & Participatory models & Theoretical article & Not applicable & No empirical data; findings not directly testable without primary research \\
\citet{okafor2025} & Adults with intellectual disabilities; neuropsychological assessment sample & Cognitive processing speed and emotion regulation & Neurocognitive approach & Quantitative study & Neuropsychological tests & No intervention component; associational findings only \\
\citet{sappok2022} & N/A -- theoretical analysis; people with intellectual disabilities (conceptual framework) & Socio-emotional development & Social neuroscience & Theoretical analysis & Not applicable & No primary sample; framework requires empirical validation in applied settings \\
\citet{parsakia2024} & Adults with intellectual disabilities; qualitative community sample & Community participation & Phenomenological approach & Qualitative study & Thematic analysis & No quantitative outcome measures; no structured intervention evaluated \\
Present study & $n=30$ adults with intellectual and psychosocial disabilities in a DCC (mean age: 36.8 yrs, $SD=10.0$; complete longitudinal sample) & Holistic arts-based SEL intervention & SEL, EI, Vygotsky, Yalom & Three-phase longitudinal design & Three-source evaluation (self-report, educators, independent observer) and effect sizes & No control group; single-site study; tool not formally validated \\
\end{longtable}
\end{landscape}
}
...
The study was conducted at a Day Care Center providing educational and psychosocial programs for adults with intellectual and psychosocial difficulties. A total of 30 adult beneficiaries participated in the study. All participants attended the daily program systematically and had the capacity, or supported capacity, to provide consent.

Thirty adults participated in the study (20 men and 10 women), with a mean age of 36.8 years ($SD = 10.0$, range: 21--56 years). Twenty-two participants (73.3\%) had an intellectual disability, five (16.7\%) had psychosocial disabilities without intellectual disability, two (6.7\%) had autism spectrum disorder without intellectual disability, and one participant (3.3\%) had a physical disability without intellectual disability. Although JARID's primary focus is intellectual disability, participants with psychosocial, autism spectrum, or physical disabilities were included as they attend the same Day Care program and share comparable support needs within this community setting. Demographic and clinical characteristics are summarised in Table~\ref{tab:demographics}.
...
\hline
Age, mean $\pm$ SD (years) & $36.8 \pm 10.0$ \\
Age range (years) & 21--56 \\
Male, $n$ (\%) & 20 (66.7\%) \\
Female, $n$ (\%) & 10 (33.3\%) \\
\hline
\multicolumn{2}{l}{\textit{Disability type}} \\
Intellectual disability, $n$ (\%) & 22 (73.3\%) \\
Psychosocial disability without intellectual disability, $n$ (\%) & 5 (16.7\%) \\
Autism spectrum disorder without intellectual disability, $n$ (\%) & 2 (6.7\%) \\
Physical disability without intellectual disability, $n$ (\%) & 1 (3.3\%) \\
\hline
\end{tabular}
\end{table}
...
The intervention was holistic and experiential in nature. It was organized around activities involving emotion recognition and expression, empathy exercises, collaborative tasks, and group processes. The intervention was theoretically informed by SEL \citep{casel2020}, emotional intelligence \citep{goleman1995}, Vygotsky's socio-cultural theory \citep{vygotsky1978}, and Yalom's therapeutic factors of group work \citep{yalom2005}.

The structure of the program remained stable throughout the implementation period. Weekly activities were conducted in small groups and included goal setting, repeated experiential patterns, and structured opportunities for social interaction. The intervention was implemented with the continuous presence of a psychologist-psychotherapist, who supported the emotional safety of the group, facilitated expression, and strengthened interpersonal understanding among participants. This role extended beyond instructional guidance and contributed to the development of therapeutic alliance and group cohesion, both of which are recognized as important mechanisms of change \citep{norcross2018,burlingame2011}.
...
Each beneficiary participated in the creation of symbolic planets, each representing a different emotion. This process promoted symbolism, self-expression, and embodied emotional processing, in line with principles of arts-based interventions \citep{malchiodi2020,goldstein2017,hinz2009}. The program culminated in a music-theatre performance at a public amphitheatre, with the participation of kindergartens and primary schools. This public presentation aimed to enhance self-esteem, social visibility, and community inclusion, consistent with the international framework of community arts inclusion \citep{nicholson2005,white2013}.
...
of the CASEL SEL framework \citep{casel2020} and established
theoretical frameworks of emotional intelligence \citep{goleman1995}.
...
The marked improvement reported by beneficiaries themselves ($d = 2.45$) is consistent with previous studies showing that participation in stable, safe, and structured group activities may enhance self-perception, confidence, and social engagement among adults with disabilities \citep{hall2009,verdonschot2009}. The increase in self-reported functioning may reflect greater self-awareness and a more positive internal experience, both of which are central dimensions of emotional intelligence as conceptualized by \citet{goleman1995}.
...
service settings internationally \citep{giummarra2022,leavy2015}.
...
Fifth, inter-rater reliability between the two trainers/educators was not formally assessed. The mean of their scores was used as a composite rating, but the absence of an intraclass correlation coefficient or equivalent measure limits the precision of the trainer-based evaluation component.
...
% REQUIRED STATEMENTS (JARID editorial policy requirements)
% ---------------------------------------------------------------
...
% TODO: Insert the URL of your public code/data repository once the review is complete.
The analysis code used in this study is available at a public repository (URL blinded for review). The dataset is available from the corresponding author upon reasonable request.
